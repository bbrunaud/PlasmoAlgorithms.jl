function generate_ubsub(;prob = prob[1], DemandPerDay = DemandPerDay[:, 1], TotalDemandPerDay=TotalDemandPerDay[1], costPerTon_ub = 200, costPerTon_lb = 0, cycleTime_ub = 200, cycleTime_lb = 0 )
